  ...
  return (
    <div >
      ...
      <div style={{ width:'110vw', marginLeft:"-42px", marginTop:"50px", display:'flex', flexDirection:' column', alignItems:'center', borderTop:'solid white 1px'}}>
        <button style={{ background: 'none', borderTop: '2px solid black', borderBottom: '2px solid black', borderLeft: 'none', borderRight: 'none', marginTop:'20px', fontSize:' 1.3rem' , color:'white'}}>Partnerships</button>
